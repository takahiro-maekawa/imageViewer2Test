...
export const getData = async () => {
  const data = [
    ...
    { id: 3, text: "label1", imageUrl: "https://images.ygoprodeck.com/images/cards/62089826.jpg" },
    { id: 4, text: "label1", imageUrl: "https://images.ygoprodeck.com/images/cards/62089826.jpg" },
    { id: 5, text: "label1", imageUrl: "https://images.ygoprodeck.com/images/cards/62089826.jpg" },
    { id: 6, text: "label1", imageUrl: "https://images.ygoprodeck.com/images/cards/62089826.jpg" }];
